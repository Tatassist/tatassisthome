...
export const QUESTIONS = [
  ...
  { id:'bottleneck', label:'Where it stalls', title:'Where do client conversations get stuck?', options:choices(['details','Getting the idea, photos, and project details together'],['fit','Figuring out which projects are a fit'],['price','After I send the estimate'],['pause','When they need time or go quiet'],['scattered','It’s scattered from the first message']) },
];
export const EDITIONS = {
  essentials: { name:'Essentials', price:27, count:6, description:'Get your inquiry and consultation process into a repeatable flow, from the first details through the project summary.' },
  working: { name:'Working System', price:47, count:13, description:'Handle inquiries, changing project details, client pauses, and deposit confirmation with a process you can actually follow.' },
  complete: { name:'Complete System', price:77, count:22, description:'Run the full inquiry-to-deposit workflow with dedicated tools for replies, body maps, estimates, closing, and follow-up.' },
};
...
export function recommend(input) {
  ...
  const reason = tierId === 'complete'
    ? 'You handle larger projects and a busy inbox, with conversations stalling around estimates, follow-up, or the wider process. Complete System adds dedicated tools for those steps.'
    : 'Working System gives you a clear place to start: core inquiry and consultation tools, plus help with project details, changes, client pauses, and deposit confirmation.';
  return { tierId, goal, pain, intro:`You want ${goal}. Your sticking point is ${pain}. Start here.`, reason, ...EDITIONS[tierId] };
}
