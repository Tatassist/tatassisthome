export const QUIZ_VERSION = 'booked-artist-quiz-2026-09-18-guide-followup';
export const RESULT_KEY = 'tatassist-booking-match-v1';
export const MARKETING_LABEL = 'Get the free guide plus booking advice and offers from Joker Ink. Unsubscribe anytime.';
...
export const EDITIONS = {
  essentials: { name:'Essentials', price:27, count:6, description:'Take your first step toward a calendar that reflects where you want your tattoo career to go.' },
  working: { name:'Working System', price:47, count:13, description:'You’ve put the hours into your art. Put that same intention behind the career it earns you. Start building toward better bookings, more rewarding projects, and clients who want your work.' },
  complete: { name:'Complete System', price:77, count:22, description:'You’ve built a client base. Now build toward the work you want to be known for. Our most in-depth edition for artists ready to make their next chapter more intentional.' },
};
...
export function recommend(input) {
  ...
  const reason = tierId === 'complete'
    ? 'Your larger projects and higher inquiry volume point to Complete: our deepest edition for the next stage of your tattoo career.'
    : 'Working is our recommended starting point for putting your goals into practice and building toward the work you want more of.';
  return { tierId, goal, pain, intro:`You want ${goal}. Picture a calendar that brings you closer to that. Put the same intention into your tattoo career that you put into your art.`, reason, ...EDITIONS[tierId] };
}
export function validateContact(input) {
  ...
  if (c.marketingConsent !== true) throw new Error('Refresh this page to get the guide and booking emails.');
  return {firstName,lastName,email,marketingConsent:true};
}
